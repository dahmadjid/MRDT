...
def displayHistory(grid):
    ...
    while i<20*widgets.k:
        ...
        flt3 = FloatLayout(size_hint =(0.85,1),pos_hint={'x':0.15,'y':0})
        ...
        you_label = Label(text = "You",color = hex("#000000"),size_hint=(None,0.1),pos_hint={'x':0, 'y':0.75},font_name = font)
        you_label.size = (10*len(you_label.text),10)
        enemy_label = Label(text = "Enemy",color = hex("#000000"),size_hint=(None,0.1),pos_hint={'x':0.66, 'y':0.75},font_name = font)
        enemy_label.size = (10*len(enemy_label.text),10)
        type_label = Label(text = game_type,color = hex("#000000"),size_hint=(None,0.1),pos_hint={'x':0, 'y':0.15},font_name = font,halign = 'left')
        type_label.size = (10*len(type_label.text),10)
        turn_label = Label(text = "Turns:"+turns,color = hex("#000000"),size_hint=(None,0.1),pos_hint={'x':0.50, 'y':0.15},font_name = font)
        turn_label.size = (10*len(turn_label.text),10)
        ...
        time_label.size = (10*len(time_label.text),10)
        #FFD700
        ...
        flt3.add_widget(turn_label)
        flt3.add_widget(type_label)
        flt3.add_widget(time_label)
        widgets.time_list.append(time_label)
        flt3.add_widget(you_label)
        #flt3.add_widget(enemy_factions_image)
        #flt3.add_widget(player_factions_image)
        flt3.add_widget(enemy_label)
        flt3.add_widget(background_player_deck_btn)
        flt3.add_widget(player_deck_btn)
        flt3.add_widget(background_enemy_deck_btn)
        flt3.add_widget(enemy_deck_btn)
        flt2.add_widget(flt3)
